...
<div id="wrap">
      ...
      <div class="header">
       ...
       <!-- maybe save items in localstorage for user? -->
       <!-- localstorage.item{index} = itemID
       retrive item and add to cart
       save index as localstorage.index??
        http://www.w3schools.com/html/html5_webstorage.asp
        only html5 supported browsers which is most
        -->
